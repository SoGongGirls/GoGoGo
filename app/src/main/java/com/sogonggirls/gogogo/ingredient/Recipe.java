...
//        View btn_back = findViewById(R.id.btn_back);
        ...
        RecipeIngAdapter adapterING_Main = new RecipeIngAdapter(getApplicationContext());
        RecipeIngAdapter adapterING_Src = new RecipeIngAdapter(getApplicationContext());
        RecipeIngAdapter adapterING_Sub = new RecipeIngAdapter(getApplicationContext());
...
//        });
    ...
    public void loadIngredientData(int num, RecipeIngAdapter adpater, GridView GV, LinearLayout Layout){
        ...
        if (DB != null) {
            ...
            if (cursor.getCount() == 0){
                ...
                for (int i = 0; i < cursor.getCount(); i++) {
                    ...
                    adpater.addItem(new RecipeIngItem(name, quantity, type_code_name));
                }
